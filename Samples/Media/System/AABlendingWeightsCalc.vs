...
BEGIN_DECLARE_OUTS()
    ...
    VAR_OUT(float2, vPixcoord, TEXCOORD1)
    VAR_OUT(float4, vOffset[3], TEXCOORD2)
END_DECLARE_OUTS()
...
BEGIN_MAIN_FUNCTION()
    ...
    // smaa
    SMAABlendingWeightCalculationVS( pOut.k_pos, pOut.k_pos, pOut.vTex, pOut.vPixcoord, pOut.vOffset );
END_MAIN_FUNCTION()
