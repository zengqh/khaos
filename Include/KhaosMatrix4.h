...
namespace Khaos
{
    ...
    public:
        ...
        bool isAffine() const
        {
            ...
            return Math::realEqual( m[3][0], 0, 1e-4f ) &&
                   Math::realEqual( m[3][1], 0, 1e-4f ) &&
                   Math::realEqual( m[3][2], 0, 1e-4f ) &&
                   Math::realEqual( m[3][3], 1, 1e-4f );
        }
        ...
        {
            khaosAssert(isAffine() && m2.isAffine());
